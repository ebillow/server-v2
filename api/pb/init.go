...
func registerC2SMsg(id msgid2.MsgIDC2S, meta *messageMeta) {
	c2s.Register(uint32(id), meta)
}

func registerS2CMsg(id msgid2.MsgIDS2C, meta *messageMeta) {
	s2c.Register(uint32(id), meta)
}

func registerS2SMsg(id msgid2.MsgIDS2S, meta *messageMeta) {
