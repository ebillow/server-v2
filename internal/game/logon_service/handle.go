...
/*-------------------角色消息-----------------*/
func onHeartBeat(_ gmsg.Head, msg *pb.C2SHeartBeat, r *role.Role) {
	now := time.Now()
...
/*-------------------非角色消息-----------------*/
func onLogin(_ gmsg.Head, msg *pb.S2SReqLogin) {
	Mgr.Login(msg)
}

func onDisconnect(_ gmsg.Head, msg *pb.S2SGt2SDisconnect) {
