...
func registerAllC2SMsg() {
	registerC2SMsg(msgid.MsgIDC2S_C2SNone, &messageMeta{
		...
		NewMessage:  func() proto.Message { return &C2SNone{} },
	})
...
func registerAllS2SMsg() {
	...
	registerS2SMsg(msgid.MsgIDS2S_S2SGt2AccLogin, &messageMeta{
		MessageType: reflect.TypeOf(S2SGt2AccLogin{}),
		NewMessage:  func() proto.Message { return &S2SGt2AccLogin{} },
	})

	registerS2SMsg(msgid.MsgIDS2S_S2SAcc2GtLogin, &messageMeta{
		MessageType: reflect.TypeOf(S2SAcc2GtLogin{}),
		NewMessage:  func() proto.Message { return &S2SAcc2GtLogin{} },
	})
